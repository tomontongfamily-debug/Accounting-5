      ...
      <div className="container">
        ...
        {!accessAllowed ? (
          ...
          <>
            ...
            {role === "Admin" && <AdminPage branch={branch} selectedDate={selectedDate} report={activeReport} result={activeResult} verifyDeposit={verifyDeposit} />}
          </>
        )}
      </div>
    </main>
...
function AdminPage({ branch, selectedDate, report, result, verifyDeposit }) {
  return (
    <div className="stack">
      ...
      <Section title="Summary">
        <div className="grid four">
          <Card title="Premium Liters" value={liter(result.fuelLiters.Premium)} />
          <Card title="Regular Liters" value={liter(result.fuelLiters.Regular)} />
          <Card title="Diesel Liters" value={liter(result.fuelLiters.Diesel)} />
          <Card title="Total Liters" value={liter(result.totalLiters)} />
          <Card title="Confirmed Bank" value={peso(result.confirmedBank)} tone="green" />
          <Card title="Pending Verification" value={peso(result.pendingBank)} tone="yellow" />
          <Card title="Cash Variance" value={peso(result.cashVariance)} tone={varianceClass(result.cashVariance)} />
